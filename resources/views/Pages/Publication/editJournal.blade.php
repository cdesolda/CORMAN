...
<div class="form-group">
    <label class="col-sm-12 col-md-3 col-lg-3" align="right">Volume</label>
    <input class="col-sm-12 col-md-9 col-lg-8" name="volume" type="text" value="{{$details->volume}}"/>
</div>
<div class="form-group">
    <label class="col-sm-12 col-md-3 col-lg-3" align="right">Number</label>
    <input class="col-sm-12 col-md-9 col-lg-8" name="number" type="text" value="{{$details->number}}"/>
</div>
<div class="form-group">
    <label class="col-sm-12 col-md-3 col-lg-3" align="right">Pages</label>
