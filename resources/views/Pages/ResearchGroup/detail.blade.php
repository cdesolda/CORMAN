@extends('Layout.main') @section('head')
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.11.1/bootstrap-table.min.css"> @endsection @section('content')
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                @foreach($sharesList as $share) @include('Pages.Publication.singleInResearchGroup', ['share'=>$share]) @endforeach
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-12" align="center">
                        <a href="{{ route('researchGroups.show', ['id'=>$researchGroup->id]) }}" id="btn-newgroup" class="btn btn-primary btn-sm"
                            role="button">OK</a>
                    </div>
                </div>
            </div>
