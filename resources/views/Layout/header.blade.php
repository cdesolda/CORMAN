<nav id="header"
    class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 fixed-header navbar navbar-dark navbar-expand-lg navbar-expand-xl">
    <!-- Navbar content -->
    <div class="brand-div col-lg-4 col-md-4 col-sm-8 col-8 col-xl-4"><a href="{{route('users.index')}}"><img
        src="{{ asset('images/logo_corman.png') }}" height="50" width="50" alt="CORMAN Logo"/></a></div>
    <form class="form-inline order-lg-2 order-md-2 order-sm-3 order-3 my-lg-0 col-lg-5 col-md-6 col-sm-12 col-xl-4">
        <input class="form-control mr-sm-2 col-xl-8 col-lg-8 col-md-6" type="search" placeholder="Search"
            aria-label="Search">
    ...
    <div class="col-xl-4 col-lg-3 order-lg-3 order-md-3 order-sm-2 col-sm-12 collapse navbar-collapse order-2"
        ...
        <div class="navbar-nav">
            ...
            <span class="badge"
                style="border: 1px solid cornflowerblue; border-radius: 10px;"><span id="notification_chat"></span></span>
            </a>
            ...
            <span class="badge"
                style="border: 1px solid cornflowerblue; border-radius: 10px;">{{ count(auth()->user()->unreadNotifications) }}</span>
            </a>
